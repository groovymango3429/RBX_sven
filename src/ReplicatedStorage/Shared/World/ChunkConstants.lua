...
ChunkConstants.CHUNK_HEIGHT = mapConfig.ChunkHeight  -- vertical slices per chunk column
...
ChunkConstants.RENDER_DISTANCE = mapConfig.RenderDistance   -- in chunk units
